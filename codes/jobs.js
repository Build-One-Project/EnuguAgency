...
for(var i = 0; i < output.length; i++){
    ...
    document.write("<h3> Job Title:  ", output[i].title, "<h3> ", "</br>")
    document.write("<h4> Category: ", output[i].category, "<h4>", "</br>")
    document.write("<h4> Job Description: ", output[i].description, "<h4>", "</br>")
